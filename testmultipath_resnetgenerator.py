...
config_fourkernels = {"siemens_hard_100":"/path/to/val_data",
            ...
            "B50f_encoder":"/path/to/checkpoints",
            "B30f_encoder":"/path/to/checkpoints",
            "BONE_encoder":"/path/to/checkpoints",
            "STD_encoder":"/path/to/checkpoints",
            "B30f_decoder":"/path/to/checkpoints",
            "STD_decoder":"/path/to/checkpoints"}
...
def validation_emphysema():
        for i in tqdm(range(196, 202, 2)): #config to run inference on model with segmentation loss only. 
            ...
            b50ftob30f = os.path.join("/path/to/output/validation_emphysema", "epoch_" + str(i), config_fourkernels["shss"])
            bonetob30f = os.path.join("/path/to/output/validation_emphysema", "epoch_" + str(i), config_fourkernels["ghss"])
            stdtob30f = os.path.join("/path/to/output/validation_emphysema", "epoch_" + str(i), config_fourkernels["gsss"])
            bonetostd = os.path.join("/path/to/output/validation_emphysema", "epoch_" + str(i), config_fourkernels["ghgs"])
...
def validation():
    for i in tqdm(range(2, 102, 2)): #config to run inference on model with segmentation loss only. 
        ...
        #Run inference on the validation dataset
        b50ftob30f = os.path.join("/path/to/output", "epoch_" + str(i), config_fourkernels["shss"])
        bonetob30f = os.path.join("/path/to/output", "epoch_" + str(i), config_fourkernels["ghss"])
        stdtob30f = os.path.join("/path/to/output", "epoch_" + str(i), config_fourkernels["gsss"])
        bonetostd = os.path.join("/path/to/output", "epoch_" + str(i), config_fourkernels["ghgs"])
