...
#SPIE data: Used unmasked images 
#Journal extension: Used masked images for siemens vendors, masked images for C, D. Adding more kernels. 

#To do: Adding more paths for C, D, FC10, FC51 and LUNG kernels. (Maybe even B kernel from Philips). 
